...
export default function SedeDeleteModal({onClose, sedeToDelete }: SedeDeleteModalProps) {
        ...
        >
            ...
            <ModalBody>
                <p className="text-sm text-gray-600 dark:text-gray-300">
                    ¿Estás seguro de que deseas eliminar la sede <span className="font-bold text-black dark:text-white">{sedeToDelete?.ciudad} {sedeToDelete?.direccion}</span>?<br /> <br />
